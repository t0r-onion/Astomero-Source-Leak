...
public abstract class Entity implements ICommandSender
{
    ...
    public boolean isTarget() {
        final ArrayList<String> targetList = TargetManager.getTargets();
        for (final String s : targetList) {
            if (ChatFormatting.stripFormatting(this.getName()).equalsIgnoreCase(s)) {
                return true;
            }
        }
        return false;
