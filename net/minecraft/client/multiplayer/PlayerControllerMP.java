...
public class PlayerControllerMP
{
    ...
    public void onPlayerRightClick2(final EntityPlayerSP thePlayer, final WorldClient theWorld, final ItemStack stack, final BlockPos position, final EnumFacing face, final Vec3d vec3d) {
        this.onPlayerRightClick(thePlayer, theWorld, stack, position, face, new Vec3(vec3d.xCoord, vec3d.yCoord, vec3d.zCoord));
    }
