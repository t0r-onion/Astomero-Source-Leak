...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void hurtCameraEffect(final float partialTicks) {
        final EventHurt hurtEvent = new EventHurt();
        hurtEvent.call();
    ...
    private void renderWorldPass(final int pass, final float partialTicks, final long finishTimeNano) {
        ...
        final EntityRenderEvent eventRenderEntity = new EntityRenderEvent(partialTicks);
        ...
        final Event3D event3D = new Event3D(partialTicks);
        event3D.call();
    ...
    private void frameInit() {
        ...
        if (this.mc.currentScreen instanceof GuiCustomMainMenu) {
            this.updateMainMenu((GuiCustomMainMenu)this.mc.currentScreen);
        }
    ...
    private void updateMainMenu(final GuiCustomMainMenu p_updateMainMenu_1_) {
        try {
            String s = null;
            ...
            final Field[] afield = GuiCustomMainMenu.class.getDeclaredFields();
