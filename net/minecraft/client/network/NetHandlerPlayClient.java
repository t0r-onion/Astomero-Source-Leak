...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void onDisconnect(final IChatComponent reason) {
        ...
        if (this.guiScreenServer != null) {
            ...
            this.gameController.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(new GuiCustomMainMenu()), "disconnect.lost", reason));
        }
    }
    ...
    public void addToSilentQueue(final Packet<?> p_147297_1_) {
        this.netManager.sendSilentPacket(p_147297_1_);
    }
