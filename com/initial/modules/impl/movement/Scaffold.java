...
public class Scaffold extends Module
{
    ...
    public void onTick(final EventTick e) {
        ...
        if (this.sprintSet.isEnabled() && MoveUtils.isMoving()) {
    ...
    public void onPre(final EventMotion e) {
        ...
        boolean shouldTower = GameSettings.isKeyDown(this.mc.gameSettings.keyBindJump) && !MoveUtils.isMoving();
            ...
            switch (mode) {
                case "Packet": {
                    ...
                    if (MovementUtils.getOnRealGround(Scaffold.localPlayer, 0.01) && Scaffold.localPlayer.ticksExisted % this.towerPacketTicks.getValue() == 0.0) {
                        ...
                        MoveUtils.setY(Scaffold.localPlayer.posY + 1.0);
                        break;
                    }
                    break;
                }
    ...
    public void place() {
        final double dir = MoveUtils.getDirection();
    ...
    private void setPosAndFace(final BlockPos var1) {
        if (this.mc.theWorld.getBlockState(var1.add(0, -1, 0)).getBlock() != Blocks.air) {
            if (this.keepYEnabled.isEnabled()) {
                final boolean towering = GameSettings.isKeyDown(this.mc.gameSettings.keyBindJump) && !MoveUtils.isMoving();
