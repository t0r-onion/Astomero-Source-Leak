...
public class GuiRenameAlt extends GuiScreen
{
    ...
    public void drawScreen(final int par1, final int par2, final float par3) {
        ...
        this.drawCenteredString(this.fontRendererObj, "Edit Alt", GuiRenameAlt.width / 2, 10, -1);
        this.drawCenteredString(this.fontRendererObj, this.status, GuiRenameAlt.width / 2, 20, -1);
        this.nameField.drawTextBox();
        this.pwField.drawTextBox();
        if (this.nameField.getText().isEmpty()) {
            Gui.drawString(this.mc.fontRendererObj, "New name", GuiRenameAlt.width / 2 - 96, 66, -7829368);
        }
        if (this.pwField.getText().isEmpty()) {
            Gui.drawString(this.mc.fontRendererObj, "New password", GuiRenameAlt.width / 2 - 96, 106, -7829368);
        }
    ...
    public void initGui() {
        ...
        this.nameField = new GuiTextField(this.eventButton, this.mc.fontRendererObj, GuiRenameAlt.width / 2 - 100, 60, 200, 20);
        this.pwField = new PasswordField(this.mc.fontRendererObj, GuiRenameAlt.width / 2 - 100, 100, 200, 20);
    }
