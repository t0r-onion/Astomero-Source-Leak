...
public class NewClickGui extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.transY < sr.getScaledHeight()) {
            Render2DUtils.prepareScissorBox(0.0, NewClickGui.height / 2 - this.transY, NewClickGui.width, NewClickGui.height / 2 + this.transY);
            final int color = new Color(1241513984, true).getRGB();
            Gui.drawRect(0.0, 0.0, NewClickGui.width, NewClickGui.height / 2 - this.transY - 1.0, color);
            Gui.drawRect(0.0, NewClickGui.height / 2 + this.transY, NewClickGui.width, NewClickGui.height, color);
            GL11.glEnable(3089);
    ...
    private void drawGradient() {
        ...
        Gui.drawGradientRect(0.0, NewClickGui.height - 100, NewClickGui.width, NewClickGui.height, secondColor, firstColor);
    }
